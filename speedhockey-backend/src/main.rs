...
async fn main() -> Result<()> {
    ...
    // let certificate = Certificate::load("crumptkin.org/cert.pem", "crumptkin.org/key.pem")
    //     .await
    //     .expect("should have been able to create certificate");
...
async fn handle_connection(incoming_session: IncomingSession) -> Result<()> {
